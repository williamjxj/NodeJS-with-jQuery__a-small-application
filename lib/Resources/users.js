...
exports.create = function (req, res)
{
	...
	//users.findOrCreateUserByWilliam(req.body);

    users.findOrCreateUserByWilliam(req.body, function(err, doc){
        if(err) { throw err; }
        if(doc) {
            req.session.doc = doc;
        }
...
exports.update = function (req, res)
{
	console.log(req.body);
	console.log('=======================!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!')
	UserProvider.updateUserByWilliam(req.user._id, req.body, function(err, users) {
		console.log('=======================++++++++++++++++++++++++++++++++')
