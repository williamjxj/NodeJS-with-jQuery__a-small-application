...
exports.index = function(req, res) {
    ...
    UserProvider.findAll(function(error, users) {
        res.render('users/index', {
            locals: {
                title: 'Peoplemelt Accounts Management',
                accounts: users
            }
        });
...
exports.new = function(req, res) {
    ...
    findOrCreateUserByPeoplemeltData(req.body, function(error, docs) {
...
exports.create = function(req, res) {
    ...
    id = req.body.uid;
    UserProvider.updateUserByPeoplemeltData(id, req.body, function(err, users) {
        console.log('=======================++++++++++++++++++++++++++++++++')
       res.render('index', {
           layout: true
       });
...
exports.load = function(id, callback) {
    callback(null, {id: id, name: "Peoplement Account" + id });
};
