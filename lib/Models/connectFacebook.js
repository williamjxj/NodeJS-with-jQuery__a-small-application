...
fbUser.prototype.findOrCreateUserByFacebookData = function(session, accessToken, accessTokenExtra, fbData) {
    console.log(__filename + ': Retrieving Facebook Account in Peoplemelt Database: [' + fbData.name + ': ' + accessToken + ']');
    ...
    User.findOne(condition, function(err, doc) {
        ...
        if(doc) {
           // console.log(util.inspect(doc));
            ...
            console.log('Insert Facebook Account to Peoplemelt Database: [' + fbData.name + ']');
