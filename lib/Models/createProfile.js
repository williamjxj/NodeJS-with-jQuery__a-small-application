...
pmUser.prototype.findOrCreateUserByWilliam = function(pmData, callback) {
    callback = callback || function() {};

    console.log('['+__filename + ']: Retrieving William Account: [' + pmData.pm_email + ']');
    ...
    User.findOne(condition, function(err, doc) {
        ...
        if(doc) {
            ...
            console.log('Insert to William Database: [' + pmData.pm_email + ']');
