...
app.get('/profile/new', function(req, res) {
    res.render('profile_new.jade', { locals: {
...
app.get('/profile/:id', function(req, res) {
    updateProfile.findById(req.params.id, function(error, article) {
...
app.post('/profile/addComment', function(req, res) {
    updateProfile.addCommentToArticle(req.param('_id'), {
        person: req.param('person'),
        comment: req.param('comment'),
        created_at: new Date()
    } , function( error, docs) {
        res.redirect('/profile/' + req.param('_id'))
    });
});
